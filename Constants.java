...
public class Constants {
    ...
    //        - constants like distances and y height. change everything to inches. 32.174 in/s^2


    // GENERAL NOTES:
    /*
    It may not be necessary to use quadratic controller for encoder counts for the indexerMotor
